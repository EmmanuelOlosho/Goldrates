...
<div class="col-10 off-1 down-15 bottom-50 md-10 md-off-1 xs-container xs-down-20 md-down-20">
 <div class="mother xs-down-10"><span class="px20 white bold">Gold Metal Articles</span></div>
 <!-- <div class="mother"><span class="px15 faded">24 - 7 news on rates9ja</span></div> -->
 <div class="mother xs-down-8 down-2 md-down-5">
   <a href="cryptoNews" class="btn-sm-3 bg-color-code-1 white px13">crypto</a>
   <a href="nairaNews" class="btn-sm-3 bg-color-code-1 white px13">Naira</a>
 </div>
 <div class="mother" id="news">
   <?php 
      $trn = date('Y-m-d'); 
      $json = file_get_contents("https://newsapi.org/v2/everything?q=gold%20metal&from=$trn&sortBy=publishedAt&apiKey=f77c16ff80fc455e8d737129df35f5dc");
      $news = json_decode($json, true);
      foreach ($news["articles"] as $i => $article) {
      ?>
     <a href="<?php echo$article['url'] ?>">
      <div class="xs-12 xs-down-10 col-4 down-5">
