...
<div class="col-10 off-1 down-15 bottom-50 md-10 md-off-1 xs-container xs-down-20 md-down-20">
 <div class="mother xs-down-10"><span class="px20 white bold">Naira Articles</span></div>
 ...
 <div class="mother xs-down-8 down-2 md-down-5">
   ...
   <a href="goldNews" class="btn-sm-3 bg-color-code-1 white px13">Gold</a>
 </div>
 <div class="mother" id="news">
   <?php 
      $trn = date('Y-m-d'); 
      $json = file_get_contents("https://newsapi.org/v2/everything?q=naira&from=$trn&sortBy=publishedAt&apiKey=f77c16ff80fc455e8d737129df35f5dc");
      $news = json_decode($json, true);
